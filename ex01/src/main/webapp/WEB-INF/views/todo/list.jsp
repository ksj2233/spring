	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				TO DO LIST
				<button id="regBtn" type="button" class="btn btn_xs pull-right">등록</button>
			</div>
			<!-- /.panel-heading -->
					...
					<div class="col-lg-12">
						<form id="searchForm" action="/todo/list" method="GET">
							<select name="type">
								...
								<option value="T" 
									<c:out value="${pageMaker.cri.type eq 'T'?'selected':''}"/>>날짜</option>
								<option value="C"
									<c:out value="${pageMaker.cri.type eq 'C'?'selected':''}"/>>내용</option>
								<option value="TC"
									<c:out value="${pageMaker.cri.type eq 'TC'?'selected':''}"/>>날짜 or 내용</option>
							</select>
